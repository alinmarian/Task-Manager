...
<li class="nav-item">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <a class="collapse-item" href="tasks.php">View All Tasks</a>
      <a class="collapse-item" href="add_tasks.php">Add Tasks</a>
    </div>
  </div>
</li>
...
<li class="nav-item">
  ...
  <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <a class="collapse-item" href="passwords.php">View All Passwords</a>
      <a class="collapse-item" href="add_passwords.php">Add Passwords</a>
    </div>
  </div>
</li>
...
<li class="nav-item">
  ...
  <div id="collapseClients" class="collapse" aria-labelledby="headingClients" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="add_clients.php">Add Clients</a>
    </div>
  </div>
</li>
